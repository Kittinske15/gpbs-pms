...
export default function ProjectDetail20() {
    ...
    const tableROI = [
        ...
        ['Year', '2023'],
        ['Target', '24,050,000 Baht'],
        ['Actual', '9,950,000 Baht'],
        ['Description', '-Revenue forecast to be accumulated 1,887m THB in 2025 target CP TBL JV -TVS synergy and develop further business impact'],
    ];
        ...
        content = <>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                ...
                <div className='detail-box' style={{ marginBottom: '20px' }}>
                    ...
                    <div className='project-objective-detail'>2. Prangploy Sukpiriyagul (Responsibility)</div>
                </div>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                <div className='detail-box' style={{ marginBottom: '20px' }}>
                ...
                <div className='detail-box' style={{ marginBottom: '20px' }}>
                    ...
                    <div className='project-objective-detail'>Target : 130,000,000 Baht</div>
                    <div className='project-objective-detail'>Actual :35,000,000 Baht </div>
                    <div className='project-objective-detail'>Investment Detail: Capital injection 130m THB (for cash flow) from JV company, inject 35m THB in 2023</div>
                </div>
            </div>
            <div className='detail-box' style={{ marginBottom: '20px' }}>
        ...
        content =
            <div className='roi-flex'>
                ...
                <div className='roi-menu-flex'>
                    ...
                    <div className='project-roi-detail'>
                        -Revenue forecast to be accumulated 1,887m THB in 2025 target CP TBL JV -TVS synergy and develop further business impact
                    </div>
                </div>
            </div>
                ...
                <div className="body_container">
                    <div className='project-detail-title-flex'>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                            ...
                            <div className='project-detail-title'>Project : Global Talent Business - New JV Company (Profit Margin15%)</div>
                        </div>
                            ...
                            <div className='project-owner-box-flex'>
                                ...
                                <div className='project-owner-detail-box'>
                                    <div className='detail-box' style={{ marginBottom: '20px' }}>
                                        ...
                                        <div className='project-description-detail'><p><strong>*Remark: Please exclude&nbsp;from the report as the revenue will be reported in&nbsp;Sixty Six Entertainment company</strong></p><p>Establising a new company with local talent content production team to produce global standard content serving global OTT&nbsp;</p></div>
                                    </div>
                                    <div className='detail-box' style={{ marginBottom: '20px' }}>
                                        <div className='project-objective'>Project Objective</div>
                                        <div className='project-objective-detail'><p>To build Thai talents to become global artists with global top talent company with potential revenue of accumulated 1,887m THB in 2025</p></div>
                                    </div>
                                    <div className='detail-box' style={{ marginBottom: '20px' }}>
                                        <div className='project-description'>Project Progress / What you have done ?(s)</div>
                                        <div className='project-objective-detail'><p><em><strong>***ON-GOING PROJECT UNDER CPG STRUCTURE***</strong></em></p></div>
                                    </div>
                                    <div className='detail-box' style={{ marginBottom: '20px' }}>
                                        <div className='project-objective'>Project Progress</div>
                                        <div className='project-description-detail'>% Progress : 25 %</div>
                                    </div>
                                </div>
                            </div>
                            <div>
