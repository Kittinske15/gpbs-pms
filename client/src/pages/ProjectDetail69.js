...
export default function ProjectDetail69() {
    ...
    const tableData = [
        ...
        ['Year', '2024'],
        ['Target', '120,000,000 Baht'],
        ['Actual', 'TBD'],
        ['Description', 'To enhance overall revenue of TN, particularly in the growing Online trends of consumer behavior and increasing demand.'],
    ];
    ...
    const originalRows = [
        {
            id: '1', type: 'Wait for approve', date: 'Thu 15 Feb 2024 10:42:34', by: 'Ongard Prapakamol'
        },
        {
            id: '2', type: 'Update', date: 'Thu 15 Feb 2024 11:14:00', by: 'Ongard Prapakamol'
        },
        {
            id: '3', type: 'Update', date: 'Mon 19 Feb 2024 17:02:50', by: 'Ongard Prapakamol'
        },
        {
            id: '4', type: 'Update', date: 'Mon 19 Feb 2024 17:12:06', by: 'Ongard Prapakamol'
        },
        {
            id: '5', type: 'Update Project Action plan', date: 'Mon 19 Feb 2024 21:16:07', by: 'Ongard Prapakamol'
        },
        {
            id: '6', type: 'Update Project Action plan', date: 'Mon 19 Feb 2024 21:16:56', by: 'Ongard Prapakamol'
        },
        {
            id: '7', type: 'Update', date: 'Thu 22 Feb 2024 12:03:48', by: 'Ongard Prapakamol'
        },
    ];
        ...
        content =
            <div className='roi-flex'>
                ...
                <div className='roi-menu-flex'>
                    ...
                    <div className='project-roi-detail'>
                        To enhance overall revenue of TN, particularly in the growing Online trends of consumer behavior and increasing demand.
                    </div>
                </div>
            </div>
                ...
                <div className="body_container">
                    <div className='project-detail-title-flex'>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                            ...
                            <div className='project-detail-title'>Project : TNN Plubisher</div>
                        </div>
                    ...
                    <div className='project-owner-grid'>
                        <div className='project-owner-box'>
                                ...
                                <div className='project-owner-detail-box'>
                                    <div className='detail-box' style={{ marginBottom: '20px' }}>
                                        ...
                                        <div className='project-description-detail'>
                                            <ul><li><strong>Digital Transition:</strong>&nbsp; Transforming&nbsp;TNN 16 from traditional TV content formats to a robust online content&nbsp;platform, ensuring a user-friendly interface and optimal accessibility across various devices and platform such as Facebook, YouTube, TikTok, X, Blockdit etc.</li><li><strong>Content Optimization:</strong> Enhance content creation and delivery strategies to meet the demands of the digital audience, focusing on engaging, shareable, and relevant content that aligns with the interests of the online community according to&nbsp;TNN 6 Pillars,&nbsp;&nbsp;TNN World Wealth Health Tech Earth.</li><li><strong>Audience View and Engagement:</strong> Implement strategies to boost audience engagement through social media integration, community-building.&nbsp;Prioritize for sponsored content and&nbsp; exclusive highllight TNN pillar content for visibility and value.</li><li><strong>Monetization Strategies:</strong> Develop and implement revenue-generating models , with a primary focus on attracting advertisers. Explore diverse monetization, including display ads, sponsored content, minumum viewed guarantee&nbsp;to maximize income streams.&nbsp;</li><li><strong>Data-Driven and Social listening: </strong>&nbsp;using analytics tools to gather insights into viewer&nbsp;behavior, preferences, and engagement metrics. Leverage this data to refine content strategies and optimize advertising placements for increased effectiveness.</li></ul>
                                        </div>
                                    </div>
                                    <div className='detail-box' style={{ marginBottom: '20px' }}>
                                        ...
                                        <div className='project-objective-detail'>
                                            <p>
                                                To transform TNN 16 into Online Media Publisher, capitalizing on the changing in consumer behavior and generating revenue through strategic advertiser partnership and sponsorship.
                                            </p>
                                        </div>
                                    </div>
                                    <div className='detail-box' style={{ marginBottom: '20px' }}>
                                        <div className='project-description'>Project Progress / What you have done ?(s)</div>
                                        <div className='project-objective-detail'><p>Selling and&nbsp;propos&nbsp;to clitents.</p><p>Jan4.15M : True= 2.31 Third Pary= 1.84M&nbsp;</p><p>Feb</p><p>March&nbsp;</p><p>&nbsp;</p></div>
                                    </div>
                                    <div className='detail-box' style={{ marginBottom: '20px' }}>
                            ...
                            <div>
                                <div className='project-create-time'>Create Date : 15 Feb 2024 10:42:34 | Create By : K. Ongard Prapakamol</div>
                                <div className='project-update-time'>Last Update : 22 Feb 2024 12:03:48 | Update By : K. Ongard Prapakamol</div>
                            </div>
                        </div>
